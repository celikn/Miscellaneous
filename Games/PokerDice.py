...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 25 14:42
The game of PokerDice
...
def start():
    print "Let's playe a game of Poker Dice."
    while game():
        pass
    scores()
...
def throws():
    ...
    while True:
        rerolls=int(raw_input("How many dice do you want to throw again?"))
        try:
            print rerolls
            ...
            pass
            print "Oppps! I didn't understand that. Please enter 1,2,3,4 or 5."
    if rerolls==0:
